    ...
    <div class="row">
      <div class="col-lg-7 mx-auto align-self-center">
        <div class=" text-center">
          ...
          <p>Somos una compañía que esta a la vanguardia en farmacia Online y Call Center, nuestra prioridad, respeto absoluto por la formula médica</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-6">
        <div class="block-16">
          <figure>
            <img src="images/productos/bg_1.jpg" alt="Image placeholder" class="img-fluid rounded">
            <a href="https://www.youtube.com/watch?v=otCzD8yXIq0" class="play-button popup-vimeo"><span
  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-6 order-md-2">
        <div class="block-16">
          <figure>
            <img src="images/productos/bg_2.jpg" alt="Image placeholder" class="img-fluid rounded">
            <a href="https://www.youtube.com/watch?v=otCzD8yXIq0" class="play-button popup-vimeo"><span
                class="icon-play"></span></a>
