      ...
      <div class="col-md-6">
        <div class="row mb-5">
          <div class="col-md-6 mb-3 mb-md-0">
            <button class="btn btn-outline-warning btn-md btn-block">Actualizar carrito</button>
          </div>
          <div class="col-md-6">
      ...
      <div class="col-md-6 pl-5">
        <div class="row justify-content-end">
          <div class="col-md-7">
            ...
            <div class="row">
              <div class="col-md-12">
              <a  href="{{ route('factura.factura')}}" class="btn btn-primary btn-lg btn-block" onclick="window.location='checkout.html'">Proceder con mi compra</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container justify-content-center">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <h2 class="display-3 text-black">¡ups!</h2>
