...
<div class="container">
    <main>
        ...
        <div class="container justify-content-betweens" id="lista-productos">
            ...
            <div class="card-deck mb-3 text-center">
                ...
                <div class="card mb-2 shadow-sm">
                  <div class="container">
                    ...
                    <div class="card-body">
                    <img src="{{ asset("images/productos/$item->Imagen") }}" class= "card-img-top" style="width: 320px; height:320px;">
                    <h1 class="card-title pricing-card-title precio">$ <span class="">{{$item->Precio}}</span></h1>
                      ...
                      <a href="{{route('productos.detalles',$item->IdProducto)}}" class="btn btn-primary agregar-carrito" >&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                          &nbsp;Detalles&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                          &nbsp;</a>
                          {{-- <a href="{{route('productos.editar',$item->IdProducto)}}" class="btn btn-primary">Editar</a> </td> --}}
                         {{-- <a href="{{route('productos.eliminar',$item->IdProducto)}}" class="btn btn-outline-danger" onclick="return confirm('¿desea eliminar el departamento? {{$item->Nombre}}')">Eliminar</a>  --}}
                    </div>
                  </div>
                </div>
